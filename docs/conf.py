# -*- coding: utf-8 -*-
#
# pytest-share_hdf documentation build configuration file, created by
...
project = 'pytest-share_hdf'
copyright = '2015, Atharva Arya'
author = 'Atharva Arya'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-share_hdf Documentation',
     [author], 1)
]
